/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e93bfee9a3eb0ed74b18c83ae0072605)
...
interface __BaseEnv_Env {
	...
	SESSION: DurableObjectNamespace<import("./src/index").PoochoSession>;
	TRANSCRIPTION_JOB: DurableObjectNamespace<import("./src/index").TranscriptionJob>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PoochoSession" | "TranscriptionJob";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SARVAM_API_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ACCOUNT_ID">> {}
}
